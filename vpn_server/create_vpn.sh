...
# Create new user and use sudo
useradd dalings
apt -y install sudo
/sbin/adduser dalings sudo
...
apt -y install zsh
echo "$varsh" > /home/mobileconfig.sh
chmod u+x /home/mobileconfig.sh
/home/./mobileconfig.sh > /home/iphone.mobileconfig
rm mobileconfig.sh
